        ...
        <div class="collapse navbar-collapse text-center" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <hr class="d-block d-md-none">
                    <a class="nav-link" href="{{ route('login') }}">Bejelentkezés<span class="sr-only">(jelenlegi)</span></a>
                </li>
                <li class="nav-item">
                    <hr class="d-block d-md-none">
    ...
    <div class="container-fluid mt-2">
        <div class="row">
            ...
            <main class="col-md-6 col-sm-12">
                <h4 class="display-4">Bejelentkezés</h4>
                <form action="#" method="get"><!--forward to login main oldalra-->
                    <div class="form-group my-5">
                        ...
                        <input type="submit" class="w-100 btn btn-primary mt-3" value="Bejelentkezés!">
